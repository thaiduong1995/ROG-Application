...
import com.duong.my_app.databinding.ActivityMainBinding
import com.duong.my_app.extension.getDotsSpanAnimator
                        ...
                        while (progress < 99) {
                            ...
                            Handler(Looper.getMainLooper()).post {
                                tvProgressBarValue.text =
                                    "${getString(R.string.resolving)} ${progress}%"
                            }
                            try {
